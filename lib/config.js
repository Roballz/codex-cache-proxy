...
export function validateConfig(input) {
  ...
  const reasoningSummaryEnabled = input.reasoningSummaryEnabled ?? false;
  requireValue(typeof reasoningSummaryEnabled === 'boolean', 'Invalid reasoning summary setting.');
