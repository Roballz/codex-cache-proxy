...
export function validateConfig(input) {
  ...
  const chatCompletionsIdentityMode = input.chatCompletionsIdentityMode ?? 'upstream';
  requireValue(
    ['global', 'upstream'].includes(chatCompletionsIdentityMode),
    'Invalid Chat Completions identity mode.',
  );
  requireValue(
