...
export function applyIdentity(body, headers, config, upstream) {
  ...
  // Sub2API historically recognizes underscore-style continuity headers,
  // while CPA/current Codex-compatible paths commonly use Session-Id.
  // Keep the adapter-specific surface narrow instead of spraying aliases.
